  ...
  return (
    <section className="py-28 md:py-36 bg-[var(--background)] overflow-hidden relative">
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-20">
        ...
        {/* ── Product Grid ── */}
        {loading ? (
          <div className="grid grid-flow-col auto-cols-[85%] sm:auto-cols-[45%] md:auto-cols-auto md:grid-flow-row md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6 overflow-x-auto snap-x snap-mandatory hide-scrollbar pb-6 -mx-6 px-6 md:mx-0 md:px-0 md:pb-0">
