...
import { navItems } from "./ManagerSidebar";
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-[100] bg-card text-foreground flex flex-col md:hidden"
          >
            <div className="p-4 border-b border-border flex justify-between items-center bg-secondary/20">
              <div>
                <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider">Branch Manager</p>
                <p className="text-sm font-bold text-foreground mt-1 tracking-wide">Khanderao Branch</p>
              </div>
