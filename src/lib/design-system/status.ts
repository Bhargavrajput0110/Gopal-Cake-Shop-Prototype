...
export const ORDER_STATUS_CONFIG: Record<OrderStatus, StatusConfig> = {
  ...
  CONFIRMED: { label: "Confirmed", color: "info", icon: MagicStar },
  READY: { label: "Ready", color: "success", icon: BoxTick },
  OUT_FOR_DELIVERY: { label: "Out For Delivery", color: "warning", icon: TruckFast },
  REFUNDED: { label: "Refunded", color: "secondary", icon: CloseCircle },
  QUOTE_DRAFT: { label: "Quote Draft", color: "secondary", icon: Edit2 },
  QUOTE_SENT: { label: "Quote Sent", color: "info", icon: MagicStar },
  QUOTE_APPROVED: { label: "Quote Approved", color: "success", icon: TickCircle },
  QUOTE_EXPIRED: { label: "Quote Expired", color: "secondary", icon: CloseCircle },
  QUOTE_REJECTED: { label: "Quote Rejected", color: "destructive", icon: CloseCircle },
  QUOTE_CONVERTED: { label: "Quote Converted", color: "success", icon: TickSquare },
