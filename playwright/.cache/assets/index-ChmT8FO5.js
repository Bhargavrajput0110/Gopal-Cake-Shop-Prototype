const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CheckoutSummary-CK8SF2a6.js","assets/jsx-runtime-C3Be6Oa3.js","assets/NotificationToast-DqZohYwE.js","assets/lucide-react-DnAA8Gws.js","assets/OrderCard-CQPPaTqH.js","assets/ProductCard-C8Iuqha4.js"])))=>i.map(i=>d[i]);
...
const D__Gopal_Cake_Shop_tests_components___components_domain_CheckoutSummary_CheckoutSummary = () => __vitePreload(() => import('./CheckoutSummary-CK8SF2a6.js'),true              ?__vite__mapDeps([0,1]):void 0).then((mod) => mod.CheckoutSummary);
const D__Gopal_Cake_Shop_tests_components___components_ui_NotificationToast_NotificationToast = () => __vitePreload(() => import('./NotificationToast-DqZohYwE.js'),true              ?__vite__mapDeps([2,1,3]):void 0).then((mod) => mod.NotificationToast);
const D__Gopal_Cake_Shop_tests_components___components_domain_OrderCard_OrderCard = () => __vitePreload(() => import('./OrderCard-CQPPaTqH.js'),true              ?__vite__mapDeps([4,1,3]):void 0).then((mod) => mod.OrderCard);
const D__Gopal_Cake_Shop_tests_components___components_domain_ProductCard_ProductCard = () => __vitePreload(() => import('./ProductCard-C8Iuqha4.js'),true              ?__vite__mapDeps([5,1]):void 0).then((mod) => mod.ProductCard);
__pwRegistry.initialize({ D__Gopal_Cake_Shop_tests_components___components_domain_CheckoutSummary_CheckoutSummary,
  D__Gopal_Cake_Shop_tests_components___components_ui_NotificationToast_NotificationToast,
  D__Gopal_Cake_Shop_tests_components___components_domain_OrderCard_OrderCard,
  D__Gopal_Cake_Shop_tests_components___components_domain_ProductCard_ProductCard });

export { requireReact as a, requireReactDom as b, getDefaultExportFromCjs as g, reactExports as r };
//# sourceMappingURL=index-ChmT8FO5.js.map
